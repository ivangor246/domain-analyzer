...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    heroCopy: 'Inspect the public footprint of a domain in one clear report.',
  ...
  ru: {
    ...
    english: 'English',
    russian: 'Русский',
    networkIntelligence: 'Сетевая аналитика',
    domainAnalyzer: 'Анализатор доменов',
    heroCopy: 'Исследуйте публичную инфраструктуру домена в одном понятном отчёте.',
